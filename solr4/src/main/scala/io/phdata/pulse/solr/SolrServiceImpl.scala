...
class SolrServiceImpl(zkAddresses: List[String], solr: CloudSolrServer) extends SolrService {
  ...
  def makeRequest(request: QueryRequest): NamedList[_ <: Any] = {
