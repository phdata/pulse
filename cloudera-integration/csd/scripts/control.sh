...
export COLLECTION_ROLLER_CONFIG=${COLLECTION_ROLLER_CONFIG:-$DEFAULT_COLLECTION_ROLLER_CONFIG}
export DEFAULT_ALERT_ENGINE_CONFIG=$(readlink -f cloudera-integration/csd/default-configs/default-alert-engine.yml)
export ALERT_ENGINE_CONFIG=${ALERT_ENGINE_CONFIG:-$DEFAULT_ALERT_ENGINE_CONFIG}
