...
log "DEFAULT_COLLECTION_ROLLER_CONFIG=${CONF_DIR}/collection-roller.yml"
log "COLLECTION_ROLLER_CONFIG=${COLLECTION_ROLLER_CONFIG:-$DEFAULT_COLLECTION_ROLLER_CONFIG}"
log "DEFAULT_ALERT_ENGINE_CONFIG=${CONF_DIR}/alert-engine.yml"
log "ALERT_ENGINE_CONFIG=${ALERT_ENGINE_CONFIG:-$DEFAULT_ALERT_ENGINE_CONFIG}"
